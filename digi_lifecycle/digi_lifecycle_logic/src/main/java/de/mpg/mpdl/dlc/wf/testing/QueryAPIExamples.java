...
public class QueryAPIExamples {
    ...
    public static void exampleToHTMLFile() throws XPathException, IOException {
        final Configuration config = new Configuration();
        final StaticQueryContext sqc = config.newStaticQueryContext();
        final XQueryExpression exp = sqc.compileQuery(new FileReader("/home/frank/data/src/saxon_samples/samples/query/books-to-html.xq"));
        final DynamicQueryContext dynamicContext = new DynamicQueryContext(config);
        dynamicContext.setContextItem(config.buildDocument(new StreamSource("/home/frank/data/src/saxon_samples/samples/data/books.xml")));
        final Properties props = new Properties();
        ...
        List results = exp.evaluate(dynamicContext);
	...
	*/
    ...
    private static void test() throws XPathException
    {
    ...
    dynamicContext.setContextItem(config.buildDocument(new StreamSource(new File("/home/frank/data/src/saxon_samples/samples/data/books.xml"))));
