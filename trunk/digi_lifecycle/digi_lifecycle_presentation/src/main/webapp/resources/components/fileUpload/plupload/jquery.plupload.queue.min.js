			...
			this
					.each(function() {
						...
						function h(l) {
							...
							c("#" + l.id).attr("class", m).find("a").css(
									"display", "block");
						}
						function f() {
							...
							c("span.plupload_upload_status", i).text(
									"Uploaded " + j.total.uploaded + "/"
											+ j.files.length + " files");
						...
						function report(){
//							window.location.href = location.pathname + "?stop=1&totalNum=" + j.files.length;
							window.location.href = location.pathname + "?stop=1";
						}
						...
						function g() {
							...
							c("a.plupload_start", i).toggleClass(
									"plupload_disabled", j.files.length === 0);
						...
						j.bind("StateChanged",function() {
							if (j.state === plupload.STARTED) {
								...
								c("span.plupload_upload_status",i).text("Uploaded 0/"+ j.files.length+ " files")
									...
									c("a.plupload_stop,div.plupload_progress",i).hide();c("a.plupload_delete", i).css("display", "block")}
							}
						);
