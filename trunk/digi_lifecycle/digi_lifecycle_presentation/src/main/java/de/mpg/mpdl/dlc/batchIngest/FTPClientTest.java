...
public class FTPClientTest {
	...
	private static  String server = "mpibftp2.mpib-berlin.mpg.de";
	private static  String proxyUser = "dlcingest";
	private static  String proxyPassword = "DLC102012!";
...
//				String dlcDirectory = System.getProperty("java.io.tmpdir")+"\"+ UUID.randomUUID().toString();
				...
				IngestImage tei = new IngestImage(tFile);
				tei.setName(tFile.getName());
