 ...
 ******************************************************************************/
package de.mpg.mpdl.jsf.components.paginator;
 ...
 *            PubItems.
 */
public abstract class BasePaginatorBean<ListElementType>
{
    protected static Logger logger = Logger.getLogger(BasePaginatorBean.class);
    /**
...
//            }
    ...
    { 
        ...
        try
        {
            // old: int goToPage = Integer.parseInt(getGoToPageTop());
